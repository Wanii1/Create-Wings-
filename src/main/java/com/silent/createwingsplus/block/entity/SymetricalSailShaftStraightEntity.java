...
public class SymetricalSailShaftStraightEntity extends SimpleKineticBlockEntity {
    ...
    public SymetricalSailShaftStraightEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SYMETRICAL_SAIL_SHAFT_STRAIGHT_BE.get(), pos, state);
