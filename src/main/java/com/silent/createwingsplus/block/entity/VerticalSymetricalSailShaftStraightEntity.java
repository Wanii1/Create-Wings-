...
public class VerticalSymetricalSailShaftStraightEntity extends SimpleKineticBlockEntity {
    ...
    public VerticalSymetricalSailShaftStraightEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.VERTICAL_SYMETRICAL_SAIL_SHAFT_STRAIGHT_BE.get(), pos, state);
